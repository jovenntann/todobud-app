...
<template>
  ...
  <div class="min-h-full">
        ...
        <div class="relative flex items-center justify-center py-5 lg:justify-between">
          ...
          <div class="absolute left-0 flex-shrink-0 lg:static">
            <a href="#">
              ...
              <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=green&shade=300" alt="TodoBud" />
            </a>
          </div>
    ...
    <main class="-mt-24 pb-8 min-h-800px">
      <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    ...
    <footer>
      <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div class="border-t border-gray-200 py-8 text-center text-sm text-gray-500 sm:text-left"><span class="block sm:inline">&copy; 2023 TodoBud</span> <span class="block sm:inline">All rights reserved.</span></div>
      </div>
    </footer>
  </div>
</template>
